...
<head>
    ...
    <link rel="stylesheet" href="../css/form_contato.css">
</head>
<body>
    ...
    <div class="container">
        <form action="gravaMensagem.php" method="POST" class="form-group">
            <h2 class="titulo">Mande-nos uma mensagem</h2>
            <input type="text" name="txtNome" class=" col-12" placeholder="Seu nome*" required><br />
            <input type="email" name="txtEmail" class=" col-12" placeholder="Seu email*" required><br />
            <input type="text" name="txtTelefone" maxlength="15" class=" col-12" placeholder="Seu telefone com ddd*" required><br />
            <textarea name="txtMensagem" class=" col-12" rows="6" placeholder="Sua mensagem*" required ></textarea><br />
            <button type="submit" class="btn btn-primary">Enviar Mensagem</button>
            <a href="../index.php" type="submit" class="btn btn-warning ml-2">Voltar</a>
        </form>
    </div>
